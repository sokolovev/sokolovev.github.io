    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="48.5" stroke="#becce1" stroke-opacity="0.25" stroke-linecap="round" fill="none" stroke-width="3"/>',
                '<circle class="precache-bar" cx="50" cy="50" r="48.5" stroke="#302F32" stroke-opacity="0.25" stroke-linecap="round" fill="none" stroke-width="3" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="48.5" stroke="#009EF8" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="3" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="45" stroke="none" fill="#000000" opacity="0.0" pointer-events="all"/>',
                '<g class="control pause">',
                '<image x="47%" y="47%" width="8" height="8" xlink:href="images/pause.svg" />',
                '</g>',
                '<g class="control play">',
                '<image x="40%" y="42%" width="20" height="20" xlink:href="images/mini_play.svg" />',
                '</g>',
